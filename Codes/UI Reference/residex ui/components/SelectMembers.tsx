        ...
        <div className="flex-none pt-6 pb-4 px-6 flex flex-col gap-4 bg-[#020617] border-b border-white/5 z-10 animate-ios-slide-in-right">
          ...
          <div className="relative transform transition-all duration-300 ease-ios focus-within:scale-[1.02]">
              ...
              <input 
                  ...
                  className="w-full bg-slate-800/50 border border-white/10 rounded-2xl py-3.5 pl-11 pr-4 text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 transition-all duration-300 ease-ios"
              />
              {searchQuery && filteredUsers.length === 0 && filteredGroups.length === 0 && (
                  <button 
                      onClick={addNewGuest}
                      className="absolute right-2 top-2 bottom-2 bg-purple-500/10 text-purple-400 px-3 rounded-xl text-xs font-bold hover:bg-purple-500 hover:text-white transition-all duration-300 ease-ios flex items-center gap-1 animate-ios-pop-in"
                  >
                      <Plus size={14} />
                      Add "{searchQuery}"
                  </button>
            ...
            <section>
                <div className="flex items-center justify-between mb-3 px-1">
                    ...
                    <button 
                        ...
                        className="text-purple-400 text-xs font-bold hover:text-purple-300 transition-colors duration-300"
                    >
                        + New Group
                    </button>
                </div>
                        ...
                        return (
                            <button
                                ...
                                className={`
                                    ...
                                    ${isSelected 
                                        ? 'bg-purple-900/20 border-purple-500/50 shadow-[0_0_20px_rgba(147,51,234,0.1)]' 
                            ...
                            >
                                ...
                                {/* Selected Indicator */}
                                {isSelected && (
                                    <div className="absolute top-3 right-3 text-purple-400 animate-ios-pop-in bg-purple-950/50 rounded-full p-1 border border-purple-500/20">
                          ...
                          >
                              <div className="flex items-center gap-3">
                                  <div className={`h-10 w-10 rounded-full flex items-center justify-center font-bold text-xs text-white shadow-sm ring-2 transition-all duration-300 ease-ios
                                      ...
                                      ${isSelected ? 'ring-purple-500/50 scale-105' : 'ring-transparent opacity-80'}`}>
                                      {user.profileImage ? (
                                  ...
                                  <div className="flex flex-col items-start">
                                      ...
                                      {user.isGuest && (
                                          <span className="text-purple-500/70 text-[10px] bg-purple-950/30 px-1.5 py-0.5 rounded border border-purple-500/10">New Guest</span>
                                      )}
                                  </div>
                              </div>
          ...
          <div className="bg-[#020617] px-6 pb-8 pt-2 animate-ios-slide-up">
            ...
            <div className="flex gap-3">
                ...
                <button 
                    ...
                    className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 text-white h-14 rounded-2xl font-bold text-sm shadow-lg shadow-purple-500/20 hover:shadow-purple-500/40 hover:scale-[1.02] active:scale-95 transition-all duration-300 ease-ios flex items-center justify-center gap-2"
                >
                    Next Step
