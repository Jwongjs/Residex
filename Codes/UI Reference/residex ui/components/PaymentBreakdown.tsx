            ...
            <div className="relative pt-4 pb-32 px-2 min-h-[600px]">
                ...
                <div className="flex justify-center mb-0 relative z-20">
                    <div className="flex flex-col items-center gap-3 animate-in zoom-in-50 fade-in duration-700 ease-spring">
                         <div className={`
                            ...
                            shadow-[0_0_60px_rgba(147,51,234,0.3)] ring-4 ring-black z-20 relative
                         ...
                         <div className="text-center bg-slate-900/80 backdrop-blur-md px-5 py-2 rounded-2xl border border-white/10 shadow-xl transform translate-y-[-10px]">
                             ...
                             <p className="text-purple-400 text-xs font-mono font-bold mt-0.5">Total RM: {totalAmount.toFixed(2)}</p>
                         </div>
                    </div>
                </div>
                    ...
                    <div className="flex justify-center my-6 z-20 relative">
                        <button 
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-full border text-xs font-bold transition-all
                                ${isSelectionMode ? 'bg-purple-500 text-white border-purple-400' : 'bg-slate-800/50 text-slate-300 border-white/10 hover:bg-white/10'}
                            `}
                        >
                            <CheckSquare size={14} />
                ...
                <div className="relative">
                    <div className="absolute left-1/2 -translate-x-1/2 top-[-20px] bottom-0 w-[2px] z-0">
                        <div className="w-full h-full bg-gradient-to-b from-purple-400 via-blue-600 to-transparent shadow-[0_0_15px_rgba(147,51,234,0.6)] origin-top animate-[growHeight_1s_ease-out_forwards]"></div>
                    </div>

                    {/* Simplified View Card */}
                    {showSimplified ? (
                        <div className="pt-12 relative z-10 flex justify-center animate-in fade-in slide-in-from-bottom-8">
                            <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-purple-500/30 p-6 rounded-[2rem] shadow-2xl w-[90%] text-center relative overflow-hidden">
                                ...
                                {activeTab === 'PENDING' && (
                                    <button 
                                        ...
                                        className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-3 rounded-xl shadow-lg shadow-purple-500/20 transition-all active:scale-95"
                                    >
                                        Settle Net Amount
                                    </button>
                                )}
                            ...
                            {displayItems.map((item, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* Connection Branch */}
                                        <div 
                                            className={`absolute top-[40px] h-[2px] bg-gradient-to-r from-purple-500/50 to-blue-400/20 shadow-[0_0_8px_rgba(147,51,234,0.4)]
                                        ...
                                        >
                                            <div className={`absolute w-1.5 h-1.5 bg-purple-400 rounded-full shadow-[0_0_10px_#a855f7] top-1/2 -translate-y-1/2 ${isLeft ? 'right-0' : 'left-0'}`}></div>
                                        </div>
                                        ...
                                        <button 
                                            ...
                                            className={`
                                                ...
                                                ${isSelected 
                                                    ? 'border-purple-400 bg-purple-950/30 shadow-[0_0_15px_rgba(147,51,234,0.1)] scale-105' 
                                                    : 'border-white/10 hover:bg-slate-800/80 hover:border-purple-500/30 hover:scale-[1.02]'}
                                            `}
                                            style={{ 
                                        ...
                                        >
                                            ...
                                            {!isSelectionMode && item.status === 'PENDING' && (
                                                <div 
                                                    ...
                                                    className="w-full mt-3 py-1.5 bg-white/5 hover:bg-purple-500/20 text-slate-400 hover:text-purple-300 rounded-lg text-[10px] font-bold transition-all border border-transparent hover:border-purple-500/30 flex items-center justify-center gap-1.5 cursor-pointer"
                                                >
                                                    Mark Paid
                                                </div>
                                            )}
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-purple-400 font-mono text-xs font-bold mt-1">RM{userTotal.toFixed(2)}</div>
                                </div>
                            </button>
                        );
                    })}
                    ...
                    {groupIds.map(gid => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="text-purple-400 font-mono text-base font-bold">RM{groupTotal.toFixed(2)}</div>
                            </button>
                        );
                    })}
                </div>
                                    ...
                                    <div className="flex items-center justify-between mb-2">
                                     ...
                                     {activeTab === 'PENDING' && (
                                        <div 
                                            ...
                                            className="mt-2 ml-14 w-fit px-3 py-1 bg-white/5 hover:bg-purple-500/20 text-slate-400 hover:text-purple-300 rounded-lg text-[10px] font-bold transition-all cursor-pointer border border-transparent hover:border-purple-500/30"
                                        >
                                            Mark Paid
                                        </div>
                                    )}
                    ...
                    {selectedEntityId && (
                        <div className="flex gap-2">
                             <button 
                                ...
                                className={`h-10 px-3 rounded-full border flex items-center gap-2 text-xs font-bold transition-all ${isSimplified ? 'bg-purple-500/20 border-purple-500 text-purple-400' : 'bg-slate-800 border-white/10 text-slate-400'}`}
                                title="Simplify Debt"
                             >
                                <Layers size={16} />
                        ...
                        {[
                            ...
                            <button
                                ...
                                className={`
                                    ...
                                    ${filterView === tab.id 
                                        ? 'bg-purple-950 text-purple-400 border-purple-500/50 shadow-lg shadow-purple-900/20' 
            ...
            {isSelectionMode && selectedBatchIds.size > 0 && (
                <div className="absolute bottom-6 left-6 right-6 z-40 animate-in slide-in-from-bottom-4">
                    <button 
                        ...
                        className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-4 rounded-2xl shadow-xl shadow-purple-500/30 flex justify-between px-6 items-center"
                    >
