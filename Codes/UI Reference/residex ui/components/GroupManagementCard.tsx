      ...
      <div className="flex gap-3 overflow-x-auto no-scrollbar pb-2 -mx-2 px-2">
         ...
         {groups.map(group => (
            <button
                ...
                className="min-w-[140px] h-32 rounded-2xl bg-black/30 border border-white/5 p-4 flex flex-col justify-between items-start hover:bg-white/10 hover:border-white/20 transition-all group relative overflow-hidden"
            >
