...
export const FriendsList: React.FC<FriendsListProps> = ({ friends, onAddFriend, onViewHistory }) => {
  return (
    <div className="bg-slate-800/40 backdrop-blur-xl rounded-[2rem] p-6 mb-4 border border-white/10 shadow-lg relative overflow-hidden">
      ...
      <div className="flex gap-4 overflow-x-auto no-scrollbar pb-2">
         ...
         >
            <div className="h-14 w-14 rounded-full bg-slate-800 border-2 border-dashed border-white/10 flex items-center justify-center text-slate-500 group-hover:text-white group-hover:border-white/30 transition-all active:scale-95">
                <History size={20} />
            </div>
