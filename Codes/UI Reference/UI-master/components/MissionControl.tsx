...
export const MissionControl: React.FC<MissionControlProps> = ({ onOpenDetail }) => {
  return (
    <button 
      ...
      className="w-full text-left bg-black/20 border border-white/5 rounded-[2rem] p-5 group hover:border-indigo-500/30 hover:bg-indigo-500/5 transition-all duration-300 relative overflow-hidden"
    >
