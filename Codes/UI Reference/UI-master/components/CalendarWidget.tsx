  ...
  return (
    <div className="mb-4">
      <button 
        ...
        className="w-full p-5 rounded-[2rem] border flex flex-col gap-4 transition-all active:scale-[0.98] group overflow-hidden relative shadow-xl bg-slate-900/80 border-white/10 backdrop-blur-xl hover:border-purple-500/30"
      >
        ...
        <div className="w-full bg-slate-800/50 rounded-xl p-3 border border-white/5 flex items-center justify-between relative z-10">
            <div className="flex items-center gap-3">
